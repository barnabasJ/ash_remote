defmodule TodoServer.Rpc.Fields do
  @moduledoc """
  Field-selection logic for the RPC core (the shared protocol core that would be
  extracted into a package used by both ash_typescript and ash_remote).
  ...
  defp atomize_keys(map), do: Map.new(map, fn {k, v} -> {String.to_existing_atom(to_string(k)), v} end)
